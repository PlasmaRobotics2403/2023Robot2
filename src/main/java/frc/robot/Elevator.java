...
public class Elevator {
     ...
     * @param talon
     */
    private void currentLimit(TalonSRX talon) {
        SupplyCurrentLimitConfiguration currentLimit = new SupplyCurrentLimitConfiguration(true, 
                                                                                Constants.CURRENT_LIMIT, 
                                                                                Constants.CURRENT_THRESHOLD, 
                                                                                Constants.THRESHOLD_TIME);
        master.configSupplyCurrentLimit(currentLimit, 0);
    }
